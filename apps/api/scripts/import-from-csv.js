...
// Script one-off de importacion. Pasar la ruta del CSV y la empresa por env:
//   CSV_PATH=/ruta/al/export.csv EMPRESA_ID=1 node scripts/import-from-csv.js
const CSV_PATH = path.resolve(process.env.CSV_PATH || './import.csv');
const EMPRESA_ID = parseInt(process.env.EMPRESA_ID, 10) || 1;
