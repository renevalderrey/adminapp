import { BRAND, LOGIN_URL, SIGNUP_URL } from '../config';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            <a href={LOGIN_URL} className="text-gray-600 hover:text-gray-900 font-medium text-sm hidden md:block">
              Iniciar sesión
            </a>
            <a href={SIGNUP_URL} className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-full font-medium text-sm transition-colors">
              Prueba Gratis
            </a>
          </div>
        </div>
